...
const CategoryPage: React.FC = () => {
  ...
  const filteredListings = useMemo(() => {
    let filtered = mockListings.filter(listing => {
      ...
      return matchesCity && matchesTime;
    });
    ...
    return filtered;
  }, [selectedCity, timeFilter, sortBy]);
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
              ...
              {/* Filter Dropdowns */}
              <div className={`grid grid-cols-1 md:grid-cols-5 gap-4 ${showFilters || window.innerWidth >= 1024 ? 'block' : 'hidden lg:grid'}`}>
                <div>
